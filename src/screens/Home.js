...
import ShopeeFeed from "../assets/img/shopeefeed.jpeg";
    ...
    return (
      <React.Fragment>
        ...
        <View style={styles.scrollViewContent}>
          <Image source={require('../assets/img/promo-shopee.jpeg')} style={{height:109, width:411}} />
          <Image source={require('../assets/img/promo-shopee2.jpeg')} style={{height:90, width:411}} />
      ...
      <View style={styles.fill}>
        ...
        >
          ...
          <TouchableHighlight style={{position:'absolute', top:7, right:'20%'}}>
            <Image source={require('../assets/icon/shopcart.png')} style={{width:24, height:24}} />
          </TouchableHighlight>
